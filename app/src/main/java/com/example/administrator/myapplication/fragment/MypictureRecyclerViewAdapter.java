...
import com.example.administrator.myapplication.fragment.pictureFragment.OnListFragmentInteractionListener;
...
public class MypictureRecyclerViewAdapter extends RecyclerView.Adapter<MypictureRecyclerViewAdapter.ViewHolder> {
    ...
    public MypictureRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        Bitmap bmp= BitmapFactory.decodeFile(mValues.get(position).path);
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (null != mListener) {
                    ...
                    mListener.onListFragmentInteractionpicture(holder.mItem);
                }
            }
        });
    }
