...
import com.example.administrator.myapplication.fragment.musicFragment.OnListFragmentInteractionListener;
...
public class MymusicRecyclerViewAdapter extends RecyclerView.Adapter<MymusicRecyclerViewAdapter.ViewHolder> {
    ...
    public MymusicRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
